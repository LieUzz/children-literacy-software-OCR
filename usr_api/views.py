    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if not obj:
                ...
                day = int(day)
                print(obj.id)
                time_obj = book_api.models.TimeGap.objects.filter(user_id=obj.id).first()
                print(time_obj)
                if not time_obj:
                    book_api.models.TimeGap.objects.update_or_create(user=obj,lasttime = day, one = 1, two = 2, three=3, four =4,five = 5, six= 6,seven= 7,eight= 8,
                                                                      nine= 9, ten= 10)
